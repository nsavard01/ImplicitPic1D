...
plt.figure()
plotAveDensity(Exp_RFBenchmark_Denis_moreCells_40xPart, 'He+', '5240 PPC Expl.', linestyle = '-', marker = '')
...
plotAveDensity(NGP_RFBenchmark_Denis_lowerDen_1048PPC_2000cells_noSmoothing, 'He+', 'NGP 1048 PPC, 2000 cells', marker = '')
plotAveDensity(NGP_RFBenchmark_Denis_lowerDen_1048PPC_2000cells_noSmoothing_OGTime, 'He+', r'NGP 1048 PPC, Expl. $\Delta t$', marker = '')
plotAveDensity(CIC_RFBenchmark_Denis_lowerDen_1048PPC_2000cells_noSmoothing_OGTime, 'He+', r'CIC, 1048 PPC, Expl. $\Delta t$', marker = '')
plt.xlim(Exp_RFBenchmark_Denis_moreCells_lowerDen.grid[0], Exp_RFBenchmark_Denis_moreCells_lowerDen.grid[-1]*1e2/2)
plt.ylim(0, None)
plt.xlabel('Distance (cm)', fontsize = 14)
plt.ylabel(r'He$^+$ Density (m$^{-3}$)', fontsize = 14)
