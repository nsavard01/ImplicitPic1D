...
Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT = dataSetExplicit('Y:/scratch/nsavard/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT/')
...
CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_250PPC_epsNeg3 = dataSet('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_250PPC_epsNeg3/')
CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_40PPC_epsNeg3 = dataSet('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_40PPC_epsNeg3/')




Exp_Norm_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads', 'ion', 20)
NGP_Norm_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/NGP_IASW_Chacon2013_Curv_Smooth_32Threads_2delT', 'ion', 20)
CIC_Norm_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT', 'ion', 20)
Exp_100PPC_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_100PPC', 'ion', 20)
Exp_200PPC_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_200PPC', 'ion', 20)
Exp_lowRes_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_30PPC_400Cells_0p2delT', 'ion', 20)
CIC_250PPC_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_250PPC_epsNeg3', 'ion', 20)
CIC_100PPC_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_100PPC_epsNeg3', 'ion', 20)
CIC_30PPC_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_30PPC_epsNeg3', 'ion', 20)
CIC_40PPC_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_40PPC_epsNeg3', 'ion', 20)
Exp_lowResOther_density = getAveDensityFiles('Y:/scratch/nsavard/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_40PPC_400Cells_0p2delT', 'ion', 20)

plt.plot(Exp_IASW_Chacon2013_4Threads.grid, Exp_Norm_density, '-', label = 'Exp.')
plt.plot(NGP_IASW_Chacon2013_Curv_Smooth_4Threads_2delT.grid, NGP_Norm_density, linestyle = '--', marker = '.', label = r'INGP')
plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT.grid, CIC_Norm_density, linestyle = '--', marker = '.', label = r'ICIC')
...
plt.plot(Exp_IASW_Chacon2013_4Threads_100PPC.grid, Exp_100PPC_density, '--', label = r'100 PPC, 512 Cells, $\frac{0.1}{\omega_{pe}}$')
plt.plot(Exp_IASW_Chacon2013_4Threads_200PPC.grid, Exp_200PPC_density, '--', label = r'200 PPC, 512 Cells, $\frac{0.1}{\omega_{pe}}$')
plt.plot(Exp_IASW_Chacon2013_4Threads.grid, Exp_Norm_density, '--', label = r'2000 PPC, 512 Cells, $\frac{0.1}{\omega_{pe}}$')
plt.plot(Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT.grid, Exp_lowResOther_density, '--', label = r'40 PPC, 400 Cells, $\frac{0.2}{\omega_{pe}}$')
plt.xlim(Exp_IASW_Chacon2013_4Threads.grid[0], Exp_IASW_Chacon2013_4Threads.grid[-1])
plt.xlabel('Distance (m)', fontsize = 14)
plt.ylabel(r'Ion Density (m$^{-3}$)', fontsize = 14)
plt.xticks(fontsize=12)
...
plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_epsNeg3.grid, CIC_Norm_density, linestyle = '--', marker = '.', label = r'2000 PPC')
plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_250PPC_epsNeg3.grid, CIC_250PPC_density, linestyle = '--', marker = '.', label = r'250 PPC')
...
plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_100PPC_epsNeg3.grid, CIC_100PPC_density, linestyle = '--', marker = '.', label = r'100 PPC')
plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_40PPC_epsNeg3.grid, CIC_40PPC_density, linestyle = '--', marker = '.', label = r'40 PPC')
plt.xlim(Exp_IASW_Chacon2013_4Threads.grid[0], Exp_IASW_Chacon2013_4Threads.grid[-1])
plt.xlabel('Distance (m)', fontsize = 14)
plt.ylabel(r'Ion Density (m$^{-3}$)', fontsize = 14)
plt.xticks(fontsize=12)
