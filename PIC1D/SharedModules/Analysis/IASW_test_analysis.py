...
Exp_Norm_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads')
Exp_200PPC_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_200PPC')
Exp_100PPC_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_100PPC')
Exp_lowRes_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ExplicitData/Exp_IASW_Chacon2013_32Threads_30PPC_400Cells_0p2delT')

NGP_HighRes_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ImplicitData/NGP_IASW_Chacon2013_512cells_NoSmooth_32Threads_2delT')

CIC_HighRes_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_512cells_NoSmooth_32Threads_2delT')
CIC_Norm_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT')
CIC_250PPC_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_250PPC_epsNeg3')
CIC_100PPC_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_100PPC_epsNeg3')
CIC_40PPC_temperature = getAveTempFiles_phaseSpace('Y:/ImplicitPic1D/ImplicitData/CIC_IASW_Chacon2013_Curv_Smooth_32Threads_2delT_40PPC_epsNeg3')
# x_center = 0.5 * (Exp_IASW_Chacon2013_4Threads.grid[0:-1] + Exp_IASW_Chacon2013_4Threads.grid[1::])
# plt.plot(x_center, Exp_IASW_Chacon2013_4Threads.getTemp('e', 20))
# plt.plot(x_center, CIC_IASW_Chacon2013_512cells_NoSmooth_32Threads_2delT.getTemp('e', 20))
# x_center = 0.5 * (Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT.grid[0:-1] + Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT.grid[1::])
# plt.plot(x_center, Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT.getTemp('e', 20))
# plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_40PPC_epsNeg3.grid, CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_40PPC_epsNeg3.getTemp('e', 20))
#
...
plt.figure()
xi = np.arange(64) + 1
x_center = 1e2 * 0.5 * (NGP_IASW_Chacon2013_Curv_Smooth_4Threads_2delT.grid[0:-1] + NGP_IASW_Chacon2013_Curv_Smooth_4Threads_2delT.grid[1::])
plt.plot(x_center, np.diff(NGP_IASW_Chacon2013_Curv_Smooth_4Threads_2delT.grid) * 1e2, 'o')
plt.xlim(Exp_IASW_Chacon2013_4Threads.grid[0], Exp_IASW_Chacon2013_4Threads.grid[-1]*1e2)
plt.xlabel(r'Cell Center Position (cm)', fontsize = 14)
...
x_center_512 = 0.5 * (Exp_IASW_Chacon2013_4Threads.grid[0:-1] + Exp_IASW_Chacon2013_4Threads.grid[1::])*1e2
plt.figure()
plt.plot(x_center_512, Exp_Norm_temperature, linestyle = '--', marker = '.', label = r'Expl.')
plt.plot(x_center_512, NGP_HighRes_temperature, linestyle = '--', marker = '.', label = r'INGP')
plt.plot(x_center_512, CIC_HighRes_temperature, linestyle = '--', marker = '.', label = r'ICIC')
plt.xlim(Exp_IASW_Chacon2013_4Threads.grid[0], Exp_IASW_Chacon2013_4Threads.grid[-1]*1e2)
plt.xlabel('Distance (cm)', fontsize = 14)
...
plt.legend(loc = 'best',fontsize=11)
plt.tight_layout()
plt.savefig('IASW/IASW_Exp_Imp_temp.pdf')
plt.savefig('IASW/IASW_Exp_Imp_temp.pdf')
plt.close()


x_center_512 = 0.5 * (Exp_IASW_Chacon2013_4Threads.grid[0:-1] + Exp_IASW_Chacon2013_4Threads.grid[1::])*1e2
x_center_400 = 1e2 * 0.5 * (Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT.grid[0:-1] + Exp_IASW_Chacon2013_4Threads_40PPC_400Cells_0p2delT.grid[1::])
plt.figure()
plt.plot(x_center_512, Exp_100PPC_temperature, '--', marker = '.', label = r'100 PPC, 512 Cells, $\frac{0.1}{\omega_{pe}}$')
plt.plot(x_center_512, Exp_200PPC_temperature, '--', marker = '.', label = r'200 PPC, 512 Cells, $\frac{0.1}{\omega_{pe}}$')
plt.plot(x_center_512, Exp_Norm_temperature, linestyle = '-', label = r'2000 PPC, 512 Cells, $\frac{0.1}{\omega_{pe}}$')
plt.plot(x_center_400, Exp_lowRes_temperature, linestyle = '--', marker = '.', label = r'40 PPC, 400 Cells, $\frac{0.2}{\omega_{pe}}$')
plt.xlim(Exp_IASW_Chacon2013_4Threads.grid[0], Exp_IASW_Chacon2013_4Threads.grid[-1]*1e2)
plt.xlabel('Distance (cm)', fontsize = 14)
plt.ylabel(r'Electron Temperature (eV)', fontsize = 14)
plt.xticks(fontsize=12)
...
plt.legend(loc = 'best',fontsize=11)
plt.tight_layout()
plt.savefig('IASW/IASW_Exp_ChangePPC_delX_temp.pdf')
plt.savefig('IASW/IASW_Exp_ChangePPC_delX_temp.png')
plt.close()


x_center_512 = CIC_IASW_Chacon2013_512cells_NoSmooth_32Threads_2delT.grid * 1e2
x_center_64 = CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT.grid * 1e2
plt.figure()
plt.plot(x_center_512, CIC_HighRes_temperature, linestyle = '-', label = r'2000 PPC, 512 Cells')
plt.plot(x_center_64, CIC_Norm_temperature, linestyle = '--', marker = '.', label = r'2000 PPC')
plt.plot(x_center_64, CIC_250PPC_temperature, linestyle = '--', marker = '.', label = r'250 PPC')
# plt.plot(NGP_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_188PPC_epsNeg3.grid, NGP_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_188PPC_epsNeg3.getDensity('ion',20), linestyle = '--', marker = '.', label = r'NGP,188 PPC')
plt.plot(x_center_64, CIC_100PPC_temperature, linestyle = '--', marker = '.', label = r'100 PPC')
plt.plot(x_center_64, CIC_40PPC_temperature, linestyle = '--', marker = '.', label = r'40 PPC')
# plt.plot(CIC_IASW_Chacon2013_Curv_Smooth_4Threads_2delT_40PPC_epsNeg3.grid*1e2, CIC_40PPC_noSmooth_density, linestyle = '--', marker = '.', label = r'40 PPC no smooth')
plt.xlim(Exp_IASW_Chacon2013_4Threads.grid[0], Exp_IASW_Chacon2013_4Threads.grid[-1]*1e2)
plt.xlabel('Distance (cm)', fontsize = 14)
plt.ylabel(r'Electron Temperature (eV)', fontsize = 14)
...
plt.legend(loc = 'best',fontsize=12)
plt.tight_layout()
plt.savefig('IASW/IASW_CIC_ChangePPC_temp.pdf')
plt.savefig('IASW/IASW_CIC_ChangePPC_temp.png')
plt.close()
