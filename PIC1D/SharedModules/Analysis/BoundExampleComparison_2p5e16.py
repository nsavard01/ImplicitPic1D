...
model2 = np.load('BoundModels/modelNonTrunc_1p0e+18nave_5Te_1Ti.npy')
...
# CIC_BoundModel_test_normal = dataSet('Y:/scratch/nsavard/ImplicitPic1D/ImplicitData/CIC_BoundModel_test_normal/')

#Energy Explicit
EP_RF = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\RF_Benchmark_case1/')
EP_RF2 = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\RF_Benchmark_case2/')
EP_RF3 = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\RF_Benchmark_case3/')
EE_RF_O = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\Original_RF_Benchmark_case1/')
EE_RF = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\RF_Benchmark_case1/')
EE_RF2 = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\RF_Benchmark_case2/')
EE_RF3 = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\RF_Benchmark_case3/')
EP_test_periodic = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\E_test_periodic/')
#EE_bc5 = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\\bc5/")
#EE_bc5_2 = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\\bc5_test2/")
EE_bc5_3 = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\\bc5_test3/")
EE_artificial_heating = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\\2p5e16_artificialheating/")
EE_neuman = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\\2p5e16_neuman/")
EP_maxwellian = dataSetExplicit("Y:\scratch\dutchyn\ExplicitData\Maxwellian_middle/")
EE_maxwellian = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\Maxwellian_middle/")
#EE_procassini = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\procassini_2p5e16/')
EE_procassini_two = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitData\procassini_2p5e16_test2/")
EE_procassini_1e18 = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\\10e18_0p2t_procassini/')
EE_procassini_1e18_inject_after_solve = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\\10e18_0p2t_procassini_injectAfterRho/')
EE_benchmark = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\EnergyExplicit_benchmark/')
#EE_benchmark_even_1e18 = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\Energy_Explicit_benchmark_Even_1e18/')
EE_benchmark_even_1e18_dt0p2 = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\\10e18_0p2t/')
#EE_benchmark_curv = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\Energy_Explicit_benchmark_Curv/')
EP_benchmark = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\Explicit_benchmark/')
#EP_benchmark_1e18 =dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\Explicit_benchmark_1e18_dt0p2/')
EP_test = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\Explicit_test/')
EE_periodic = dataSetExplicit('Y:\scratch\dutchyn\EnergyExplicitData\EE_periodic/')
EP_periodic = dataSetExplicit('Y:\scratch\dutchyn\ExplicitData\EP_periodic/')
EP_neuman = dataSetExplicit("Y:\scratch\dutchyn\ExplicitData\\2p5e16_neuman/")
EES_peroidic = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitShiftedData\EES_periodic/")
EES_rf1 = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitShiftedData\RF_Benchmark_case1/")
EES_rf2 = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitShiftedData\RF_Benchmark_case2/")
EES_reflux = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitShiftedData\\reflux_benchmark/")
EES_1e18 = dataSetExplicit("Y:\scratch\dutchyn\EnergyExplicitShiftedData\Reflux_benchmark_1e18_dt0p2/")
