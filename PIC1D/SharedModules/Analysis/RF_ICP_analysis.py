...
plotAveDensity(Exp_ICP_highDensity_highPressure_standRF_2500cells_10000delT_3200PPC, 'He+', label = r'INGP stand in', marker = '')
plt.xlim(Exp_ICP_highDensity_highPressure_standRF_2500cells_10000delT_3200PPC.grid[0], Exp_ICP_highDensity_highPressure_standRF_2500cells_10000delT_3200PPC.grid[-1]*1e2/2)
plt.ylim(0, None)
plt.xlabel('Distance (cm)', fontsize = 14)
plt.ylabel(r'He$^+$ Density (m$^{-3}$)', fontsize = 14)
...
plotAvePhi(Exp_ICP_highDensity_highPressure_standRF_2500cells_10000delT_3200PPC, label = r'INGP stand in', marker = '')
plt.xlim(Exp_ICP_highDensity_highPressure_standRF_2500cells_10000delT_3200PPC.grid[0], Exp_ICP_highDensity_highPressure_standRF_2500cells_10000delT_3200PPC.grid[-1]*1e2/2)
plt.ylim(0, None)
plt.xlabel('Distance (cm)', fontsize = 14)
