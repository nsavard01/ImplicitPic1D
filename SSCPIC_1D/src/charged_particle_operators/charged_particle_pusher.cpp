...
void charged_particle_pusher::push_particle_trajectories_non_uniform(const int thread_id, std::vector<charged_particle>& particle_list, const std::vector<target_particle>& target_particle_list, const non_uniform_domain& world, const std::vector<double>& E_field){
...
void charged_particle_pusher::push_particle_trajectories_uniform(const int thread_id, std::vector<charged_particle>& particle_list, const std::vector<target_particle>& target_particle_list, const uniform_domain& world, const std::vector<double>& E_field){
