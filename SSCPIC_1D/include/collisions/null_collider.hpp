...
public:
    ...
    void generate_null_collisions(const int thread_id, const std::vector<target_particle> &target_particle_list, const double time_step);
    ...
    // void initialize_diagnostic_files(const std::string& dir_name, ,const std::vector<target_particle>& target_particle_list) const;
