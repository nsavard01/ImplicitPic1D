...
contains
    ...
    subroutine addMaxwellianLostParticles(particleList, T_e, T_i, irand, delIdx, idxReFlux, reFluxMaxIdx)
        ! Add power to all particles in domain
        ...
        do i=1, delIdx(1)
            ...
            particleList(1)%phaseSpace(1, particleList(1)%N_p + i) = NumberXNodes - ran2(irand) * 20
